...
class SignupPage(ctk.CTkFrame):
    def __init__(self, parent, show_login_callback):
        ...
        # Profession dropdown
        ctk.CTkLabel(form_frame, text="Select Profession:", font=("Helvetica", 12)).pack(pady=(10, 0))
...
class ProfilePage(ctk.CTkFrame):
    def __init__(self, parent, username):
        ...
        # Main container (pack this first)
        main_frame = ctk.CTkFrame(self, fg_color="#1a1a1a")
        main_frame.pack(fill="both", expand=True, padx=20, pady=20)
...
class WordLearningPage(ctk.CTkFrame):
    def __init__(self, parent, username, profession):
        super().__init__(parent, fg_color="transparent")
        self.pack(fill="both", expand=True)
        self.username = username
